...
from GroovyChat.modules.helpers import CHATBOT_ON, is_admins


@GroovyChat.on_cmd("chatbot", group_only=True)
...
async def chatbot_text(client: Client, message: Message):
    ...
    if not message.reply_to_message:
        ROCKYdb = MongoClient(MONGO_URL)
        ROCKY = ROCKYdb["ROCKYDb"]["ROCKY"]
        is_ROCKY = ROCKY.find_one({"chat_id": message.chat.id})
        if not is_ROCKY:
